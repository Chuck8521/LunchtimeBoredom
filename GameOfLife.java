...
public class GameOfLife {
  ...
  public static void main(String[] args){
    ...
    //Line 2: The number of states you want simulated
    //Line 3: The 1st line of the life array (0 0 0 1 0 0 1 0)
    Scanner input = new Scanner(System.in);
    String in = input.nextLine();
    int n = Integer.parseInt(in);
    in = input.nextLine();
    int states = Integer.parseInt(in);
